...
class MainScreen : public Engine {
    ...
    private:
        ...
        sf::Texture t_background_main, t_maintittle, t_copyright_editon, t_atlas;
        sf::Sprite s_background_main, s_maintittle, s_copyright_edition, s_button_singleplayer, s_button_multiplayer, s_button_settings, s_button_quit;
